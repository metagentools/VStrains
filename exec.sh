...
python eval_script/quast_evaluation.py -c1 benchmark/fastq/5-strain-HIV-20000x/output_careful/contigs.fasta -c2 acc_5hiv_careful/tmp/post_contigs.fasta -c3 acc_5hiv_careful/strain.fasta -ref benchmark/strains/5-strain-HIV.fasta -o quast5hiv/
