...
python eval_script/quast_evaluation.py -cs benchmark/fastq/5-strain-HIV-20000x/output_careful/contigs.fasta ~/Desktop/benchmark/shortread/vgflow+savage/vgflow5hiv/haps.final.fasta acc_5hiv_careful/strain.fasta -ref benchmark/strains/5-strain-HIV.fasta -o quast5hiv/
...
python eval_script/quast_evaluation.py -cs benchmark/fastq/6-strain-poliovirus/output/contigs.fasta ~/Desktop/benchmark/shortread/vgflow+savage/vgflow6polio/haps.final.fasta acc_6_polio/strain.fasta -ref benchmark/strains/6-strain-polio.fasta -o quast6polio/
