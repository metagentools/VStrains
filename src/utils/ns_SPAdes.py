...
from utils.ns_IO import graph_to_gfa, flipped_gfa_to_graph, get_contig, gfa_to_graph
...
def run(args):
    ...
    contig_dict = get_contig(args.path_file, simp_node_dict, simp_edge_dict, args.min_len)
