...
python src/__init__.py -a spades -g benchmark/5-virus-mix/output_5hiv_labmix/assembly_graph_after_simplification.gfa -p benchmark/5-virus-mix/output_5hiv_labmix/contigs.paths -o acc_5hiv_labmix/ -d
